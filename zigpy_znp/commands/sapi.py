...
class SAPICommands(enum.Enum):
    ...
    ZBStartReq = CommandDef(CommandType.SREQ, 0x00)
    ...
    ZBSendDataRequest = CommandDef(
        ...
        req_schema=t.Schema(
            (
                ...
                t.Param(
                    "CommandId", t.uint16_t, "The command id to send with the message"
                ),
                t.Param(
                    "Handle",
                    t.uint8_t,
    ...
    ZBFindDeviceConfirm = CommandDef(
        ...
        req_schema=t.Schema(
            (
                t.Param(
                    "SearchType", t.uint8_t, "The type of search that was performed"
                ),
                t.Param(
                    "SearchKey", t.uint16_t, "Value that the search was executed on"
                ),
