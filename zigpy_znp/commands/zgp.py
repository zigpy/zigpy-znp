...
class ZGPCommands(CommandsBase, subsystem=Subsystem.ZGP):
    DataReq = CommandDef(
        ...
        req_schema=t.Schema(
            (
                t.Param(
                    "Action", t.Bool, "True/False -- add/remove GPDF into the queue"
                ),
                ...
                t.Param(
                    "Handle", t.uint8_t, "GPEP handle to match req to confirmation"
                ),
    ...
    DataInd = CommandDef(
        ...
        req_schema=t.Schema(
            (
                t.Param(
                    "Status", t.uint8_t, "The status code as returned by the dGP stub"
                ),
                t.Param(
                    "RSSI",
                    t.int8s,
                ...
                t.Param(
                    "SeqNum", t.uint8_t, "The sequence number from MAC header of MPDU"
                ),
                t.Param(
                    "SrcAddrMode", t.AddrMode, "The source addressing mode of MPDU"
                ),
